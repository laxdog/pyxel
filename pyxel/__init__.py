...
GAMEPAD_3_A: int = constants.GAMEPAD_3_A
GAMEPAD_3_B: int = constants.GAMEPAD_3_B
GAMEPAD_3_DOWN: int = constants.GAMEPAD_3_DOWN
GAMEPAD_3_LEFT: int = constants.GAMEPAD_3_LEFT
GAMEPAD_3_LEFT_SHOULDER: int = constants.GAMEPAD_3_LEFT_SHOULDER
GAMEPAD_3_RIGHT: int = constants.GAMEPAD_3_RIGHT
GAMEPAD_3_RIGHT_SHOULDER: int = constants.GAMEPAD_3_RIGHT_SHOULDER
GAMEPAD_3_SELECT: int = constants.GAMEPAD_3_SELECT
GAMEPAD_3_START: int = constants.GAMEPAD_3_START
GAMEPAD_3_UP: int = constants.GAMEPAD_3_UP
GAMEPAD_3_X: int = constants.GAMEPAD_3_X
GAMEPAD_3_Y: int = constants.GAMEPAD_3_Y
GAMEPAD_4_A: int = constants.GAMEPAD_3_A
GAMEPAD_4_B: int = constants.GAMEPAD_3_B
GAMEPAD_4_DOWN: int = constants.GAMEPAD_4_DOWN
GAMEPAD_4_LEFT: int = constants.GAMEPAD_4_LEFT
GAMEPAD_4_LEFT_SHOULDER: int = constants.GAMEPAD_4_LEFT_SHOULDER
GAMEPAD_4_RIGHT: int = constants.GAMEPAD_4_RIGHT
GAMEPAD_4_RIGHT_SHOULDER: int = constants.GAMEPAD_4_RIGHT_SHOULDER
GAMEPAD_4_SELECT: int = constants.GAMEPAD_4_SELECT
GAMEPAD_4_START: int = constants.GAMEPAD_4_START
GAMEPAD_4_UP: int = constants.GAMEPAD_4_UP
GAMEPAD_4_X: int = constants.GAMEPAD_4_X
GAMEPAD_4_Y: int = constants.GAMEPAD_4_Y
